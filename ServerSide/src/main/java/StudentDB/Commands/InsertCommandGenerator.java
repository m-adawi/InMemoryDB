...
public class InsertCommandGenerator extends SpecializedCommandGenerator {
    private final static InsertCommandGenerator insertCommandGenerator = new InsertCommandGenerator();

    public static SpecializedCommandGenerator getInstance() {
        return insertCommandGenerator;
    }

    private InsertCommandGenerator(){

    }

    @Override
    public Command getFromZStatement(ZStatement query) {
        return getFromZStatement((ZInsert) query);
    }

    public Command getFromZStatement(ZInsert query){
